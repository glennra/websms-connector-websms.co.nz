 ...
 * @author flx
 */
public final class ConnectorWebSMSconz extends BasicConnector {
	/** Tag for output. */
	private static final String TAG = "websms.co.nz";

	/** smsflatrate.net gateway URL. */
	private static final String URL = "http://websms.co.nz/signup.php";
